                ...
                >
                  {property.amenities.map((amenity: string, index: number) => {
                    ...
                    return (
                      ...
                      >
                        <Ionicons name={getAmenityIcon(amenity) as any} size={24} color="#FFFFFF" style={{ marginBottom: 8 }} />
                        <Text style={{ color: '#FFFFFF', fontSize: 12, fontWeight: '600', textAlign: 'center' }} numberOfLines={2}>
                          {amenity}
                        </Text>
                      </View>
                    );
